...
<div class="card">
    <div class="card-body">
        ...
        @else
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center">{{ $dataMahasiswa->firstItem() + $loop->index }}</td>
                            ...
                            <td class="text-center"><span class="pill pill-olive">{{ $item->kelas }}</span></td>
            ...
            {!! $dataMahasiswa->links('components.pagination') !!}
        @endif
    </div>
</div>
@endsection
